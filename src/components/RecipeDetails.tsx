...
import { Box, Card, CardContent, CardHeader, Grid, Grid2, List, ListItem, Paper, Typography } from "@mui/material";
    ...
    return (
        <Grid2 container justifyContent="flex-start" >
            <Grid item xs={12} md={12}>
                {/* <Paper elevation={4} sx={{ padding: 3, backgroundColor: "#f7f7f7", height: "100%" }}> */}
